...
function randomProtein (theDocument) {
	...
	for (var i=1; i <= seqNum; i++) {
		outputWindow.document.write ('&gt;' + 'random sequence ' + i + ' consisting of ' + enteredNumber + ' residues.\n');
		writeRandomSequence(["A","C","D","E","F","G","H","I","K","L","M","N","P","Q","R","S","T","V","W","Y"], enteredNumber);
