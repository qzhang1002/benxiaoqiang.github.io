...
function restSummary (theDocument) {	
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		outputWindow.document.write(getInfoFromTitleAndSequenceAndTopology(title, newDna, theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value));
