...
function restMap (theDocument) {	
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		openPre();
		outputWindow.document.write(getInfoFromTitleAndSequenceAndTopology(title, newDna, theDocument.forms[0].elements[7].options[theDocument.forms[0].elements[7].selectedIndex].value));
...
function layoutRestTrans (dnaSequence, geneticCode, restrictionSiteCollection, basesPerLine, readingFrame)	{
