...
function mutateDna (theDocument) {	
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		writeMutatedSequence(newDna, ["g", "a", "c", "t"], enteredNumber, theDocument.forms[0].elements[5].options[theDocument.forms[0].elements[5].selectedIndex].value, newDna.length - theDocument.forms[0].elements[6].options[theDocument.forms[0].elements[6].selectedIndex].value - 1);
