...
function translate (theDocument) {	
	...
	var rfText = theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value;
	if ((theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value).match(/^\d+$/)) {
		rfText++;
	}
	else {
		rfText = '"' + theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value + '"';
	}	
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		writeTranslation(newDna, geneticCode, theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value, theDocument.forms[0].elements[5].options[theDocument.forms[0].elements[5].selectedIndex].value);
